...
This is my first Github project and a majority of the code was generated with pre-trained GPT-4 model as a learning exersise. If this repository and code are not properly optimized, feel free to log an issue reccomending changes.
